...
object DateFormats {
    ...
    const val TIME_FORMAT_HHmmss = "HHmmss"
    ...
    const val DATE_FORMAT_DDDyy = "DDDyy"
    ...
    const val DATE_FORMAT_yyMMddhh = "yyMMddHH"
    const val DATE_FORMAT_yyyyMMddHHmmss = "yyyyMMddHHmmss"
    const val DATE_FORMAT_yyyy_MM_dd_HH_mm_ss = "yyyy-MM-dd_HH:mm:ss"
    const val DATE_FORMAT_yyyy_MM_dd_T_HH_mm_ss_000000_0000 = "yyyy-MM-dd'T'HH:mm:ss.000000+0000"
}